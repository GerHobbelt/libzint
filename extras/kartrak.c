...
static void print_head(char car_number[], double bordersize) {
...
static void print_check(double x, double y) {
    /* Print checkerboard */
    int w, h;
...
static void print_two(double x, double y) {
...
static void print_three(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#ef0000\" />\n", x, y + 0.5);
    hrt(x, y, "3");
}

static void print_four(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"1.00in\" fill=\"#ef0000\" />\n", x, y);
    hrt(x, y, "4");
}

static void print_five(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#0000e0\" />\n", x, y + 0.5);
    hrt(x, y, "5");
}

static void print_six(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#0000e0\" />\n", x, y);
    print_check(x, y + 0.5);
    back_square(x, y);
    hrt(x, y, "6");
...
static void print_seven(double x, double y) {
    print_check(x, y);
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#ef0000\" />\n", x, y + 0.5);
    hrt(x, y, "7");
}

static void print_eight(double x, double y) {
    print_check(x, y + 0.5);
    back_square(x, y);
    hrt(x, y, "8");
}

static void print_nine(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"1.00in\" fill=\"#0000e0\" />\n", x, y);
    hrt(x, y, "9");
}

static void print_ten(double x, double y) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#ef0000\" />\n", x, y);
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"5.75in\" height=\"0.5in\" fill=\"#0000e0\" />\n", x, y + 0.5);
    hrt(x, y, "10");
}

static void print_start(double bordersize) {
...
static void print_stop(double bordersize) {
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"4.50in\" height=\"0.5in\" fill=\"#0000e0\" />\n", bordersize + 1.25, 1.35 + bordersize);
    printf("        <rect x=\"%.2fin\" y=\"%.2fin\" width=\"4.50in\" height=\"0.5in\" fill=\"#ef0000\" />\n", bordersize, 1.85 + bordersize);
    hrt(bordersize, 1.35 + bordersize, "STOP");
}

static void print_label(int posn, double bordersize, int digit) {
